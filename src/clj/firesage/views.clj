...
(defn head []
  [:head
   ...
   [:meta {:name "description" :content (str "FireSage is a web portal for displaying near-term fire forecast "
   ...
   [:meta {:name "keywords" :content "firesage california fire forecast cec epic sig reax"}]
