...
(def ^:private alert-west-api-key      (delay (get-config :pyregence.cameras/alert-west-api-key)))
(def ^:private alert-west-api-defaults (delay {:headers {"X-Api-Key" @alert-west-api-key}}))
