   ...
   [:div {:style {:margin "1rem" :width  "75%"}}
    ...
    [:div
     ...
     [:p
      ...
      " (“EPL License”), which is expressly incorporated in these Terms. Your use of any Content, except as provided in these Terms, including in the EPL License, without our written permission is strictly prohibited."]]
    [:div
