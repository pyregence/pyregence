...
(def utility-psps-common-underlays
  {:psps-static-zones {:enabled?      (constantly true)
                       :opt-label     "Static Zones"
                       :z-index       104
                       :filter-set    #{"fire-detections" "conus-buildings"} ;; ??? FIXME
                       :geoserver-key :psps}})
...
(def near-term-forecast-options
  {:fuels        {:opt-label     "Fuels"
                  ...
                  :params          {:output     {:opt-label  "Output"
                                                 ...
                                                 :options    {:times-burned    {:opt-label "Relative burn probability"
                                                              ...
                                                              :crown-fire-area {:opt-label    "Crown fire area"
                                                                                ...
                                                                                :units        "Acres"
                                                                                :disabled-for #{:tlines :nve :liberty :northwestern :otec :pnm :tep}}
   ...
   :psps-zonal   {:opt-label       "PSPS"
                  :filter          "psps-zonal"
                  :geoserver-key   :psps
                  :underlays       (merge common-underlays near-term-forecast-underlays utility-psps-common-underlays)
                  :reverse-legend? true
                  :time-slider?    true
