...
(defn weather-station
  [& {:keys [height width]}]
  [:svg {:width width :height height :viewBox "0 0 33 29" :fill "none" :xmlns "http://www.w3.org/2000/svg"}
   [:path {:d "M25.6316 3.42156L25.6316 9.7941C25.6316 9.95414 25.7612 10.0838 25.9213 10.0838C27.8381 10.0838 29.3972 8.52466 29.3972 6.60783C29.3972 4.691 27.8381 3.1319 25.9213 3.1319C25.7612 3.1319 25.6316 3.26152 25.6316 3.42156Z" :fill "white"}]
   [:path {:d "M26.2111 10.6631C26.051 10.6631 25.9214 10.7927 25.9214 10.9527L25.9214 12.6907C25.9214 12.8507 26.051 12.9804 26.2111 12.9804C26.3711 12.9804 26.5007 12.8507 26.5007 12.6907L26.5007 10.9527C26.5007 10.7927 26.3711 10.6631 26.2111 10.6631Z" :fill "white"}]
   [:path {:d "M28.5695 10.125L29.6297 11.5328C29.726 11.6609 29.9078 11.6863 30.0352 11.59C30.1627 11.4944 30.1888 11.3133 30.0924 11.1844L29.0323 9.77669C28.936 9.64852 28.7542 9.62317 28.6268 9.71948C28.5 9.81507 28.4725 9.99611 28.5695 10.125Z" :fill "white"}]
   [:path {:d "M30.0128 7.58691C29.9657 7.73753 30.0483 7.90119 30.2025 7.95044L31.9173 8.48921C32.0701 8.537 32.2323 8.45227 32.2809 8.29948C32.3287 8.14523 32.2439 7.98375 32.0911 7.93595L30.3763 7.39718C30.2235 7.34939 30.0613 7.43411 30.0128 7.58691Z" :fill "white"}]
   [:path {:d "M30.0172 4.71494C29.8637 4.76346 29.7804 4.92712 29.8274 5.07847C29.8752 5.23127 30.0382 5.31599 30.191 5.2682L31.9058 4.72943C32.0578 4.68163 32.1433 4.52015 32.0955 4.3659C32.0477 4.21311 31.8848 4.12838 31.732 4.17617L30.0172 4.71494Z" :fill "white"}]
   [:path {:d "M28.0822 2.74957C27.9852 2.87847 28.0127 3.0595 28.1394 3.15509C28.2676 3.2514 28.4487 3.22606 28.545 3.09788L29.6051 1.69013C29.7022 1.56196 29.6754 1.38092 29.5479 1.28461C29.4197 1.18829 29.2387 1.21364 29.1424 1.34182L28.0822 2.74957Z" :fill "white"}]
   [:path {:d "M25.9214 0.524951L25.9214 2.26292C25.9214 2.42295 26.051 2.55258 26.2111 2.55258C26.3711 2.55258 26.5007 2.42295 26.5007 2.26292L26.5007 0.524951C26.5007 0.364914 26.3711 0.235291 26.2111 0.235291C26.051 0.235291 25.9214 0.364914 25.9214 0.524951Z" :fill "white"}]
   [:path {:d "M4.3228 9.9379C2.45764 9.9379 0.941162 8.42142 0.941162 6.55626C0.941162 4.6911 2.45764 3.17462 4.3228 3.17462C6.18796 3.17462 7.70444 4.6911 7.70444 6.55626C7.70444 8.42142 6.18796 9.9379 4.3228 9.9379ZM4.3228 5.2036C3.57734 5.2036 2.97015 5.8108 2.97015 6.55626C2.97015 7.30172 3.57734 7.90892 4.3228 7.90892C5.06826 7.90892 5.67546 7.30172 5.67546 6.55626C5.67546 5.8108 5.06826 5.2036 4.3228 5.2036Z" :fill "white"}]
   [:path {:d "M18.5068 12.4741H14.3737C13.8028 12.4741 13.3405 12.0283 13.3405 11.4778V6.16375C13.3405 4.51493 14.7304 3.17462 16.4403 3.17462C18.1502 3.17462 19.5401 4.51493 19.5401 6.16375V11.4778C19.5401 12.0283 19.0778 12.4741 18.5068 12.4741ZM15.407 10.4814H17.4736V6.16375C17.4736 5.61463 17.0097 5.16737 16.4403 5.16737C15.8708 5.16737 15.407 5.61463 15.407 6.16375V10.4814Z" :fill "white"}]
   [:path {:d "M17.5675 12.756H15.5949V15.0104H17.5675V12.756Z" :fill "white"}]
   [:path {:d "M13.0588 5.71088H8.26813V7.6835H13.0588V5.71088Z" :fill "white"}]
   [:path {:d "M24.8945 5.71088H19.822V7.6835H24.8945V5.71088Z" :fill "white"}]
   [:path {:d "M18.5294 28.5294H16.7396V17.0739H16.4957V28.5294H14.7059V15.5294H18.5294V28.5294Z" :fill "white"}]])
...
(defn exclamation-point [& {:keys [height width]}]
  [:svg {:height  height
         :viewBox "0 0 24 24"
         :width   width}
   [:path
...
(defn measure-ruler [& {:keys [height width]}]
  [:svg {:height  height
         ...
         :width   width}
   [:path {:d "m485.408 4.409-101.893 101.893 42.106 42.106c5.858 5.858 5.858 15.355 0 21.213-5.857 5.857-15.355
