...
(defn measure-ruler []
  [:svg {:viewBox "0 0 511.016 511.016" :xmlns "http://www.w3.org/2000/svg"}
...
(defn right-arrow []
  [:svg {:viewBox "0 0 451.846 451.847"}
   [:path {:d "M345.441,248.292L151.154,442.573c-12.359,12.365-32.397,12.365-44.75,0c-12.354-12.354-12.354-32.391,0-44.744\n\t\tL278.318,225.92L106.409,
              54.017c-12.354-12.359-12.354-32.394,0-44.748c12.354-12.359,32.391-12.359,44.75,0l194.287,194.284\n\t\tc6.177,6.18,9.262,14.271,
              9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"}]])

(defn return []
  [:svg {:viewBox "0 0 32 32"}
    [:path {:d "m19.5078 8.3394h-11.5585l1.1722-1.7419a1.5326 1.5326 0 0 0 -1.2683-2.3931h-.0032a1.67 1.67 0 0 0 -1.3042.6268l-3.6065
                4.5088a.8.8 0 0 0 0 .9995l3.6069 4.5085a1.67 1.67 0 0 0 1.3042.6269h.0028a1.5326 1.5326 0 0 0 1.2683-2.393l-1.1725-1.7425h11.5588a6.728
