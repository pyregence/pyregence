...
(defn share []
  [:svg {:viewBox "0 0 70 70" :style {:fill-rule "evenodd" :clip-rule "evenodd" :stroke-line "join:round" :stroke-miter "limit:2"}}
   [:g {:transform "matrix(0.898341,0,0,0.874937,-9.91644,-8.74985)"}
    [:path {:d "M88.96,32.38C88.96,31.8 88.67,31.27 88.18,30.97L56.25,10.27C55.72,9.93 55.06,9.91 54.51,10.22C53.97,10.51 53.62,11.09
               53.62,11.72L53.65,18.7C53.55,18.73 53.46,18.75 53.36,18.79C52.75,18.99 52.15,19.2 51.45,19.42C47.55,20.82 43.76,22.67
               40.15,24.95C33.28,29.3 27.11,35.31 22.38,42.3C17.78,49.06 14.41,56.87 12.64,64.85C10.9,72.56 10.58,80.75 11.67,88.53C11.79,89.38
               12.5,89.99 13.36,89.99C14.21,89.99 14.93,89.38 15.05,88.53C16.05,81.47 18.32,74.66 21.6,68.84C24.72,63.31 28.87,58.46
               33.63,54.83C38.12,51.41 43.23,49.04 48.37,47.99C50.12,47.63 51.93,47.43 53.77,47.36L53.79,53.42C53.79,54.03 54.13,54.61
               54.69,54.9C55.23,55.21 55.9,55.17 56.43,54.83L88.19,33.81C88.67,33.49 88.96,32.96 88.96,32.38Z"}]]])

(defn flag []
  [:svg {:viewBox "0 0 24 24"}
   [:path {:d "m19.25 8 2.55-3.4a1.0007 1.0007 0 0 0 -.8-1.6h-12a1 1 0 0 0 -2 0v17h-1a1 1 0 0 0 0 2h4a1 1 0 0 0 0-2h-1v-7h12a1.0007 1.0007 0 0 0 .8-1.6z"}]])

(defn magnify-zoom-in []
  [:svg {:enable-background "new 0 0 32 32" :viewBox "0 0 32 32"}
   [:path {:d "m27.414 24.586-5.077-5.077c1.049-1.581 1.663-3.474 1.663-5.509 0-5.514-4.486-10-10-10s-10 4.486-10 10 4.486 10 10 10c2.035 0 3.928-.614 5.509-1.663l5.077 5.077c.78.781 2.048.781 2.828 0 .781-.781.781-2.047 0-2.828zm-20.414-10.586c0-3.86 3.14-7 7-7s7 3.14 7 7-3.14 7-7 7-7-3.14-7-7z"}]
   [:path {:d "m19 14c0 .552-.448 1-1 1h-3v3c0 .552-.448 1-1 1s-1-.448-1-1v-3h-3c-.552 0-1-.448-1-1s.448-1 1-1h3v-3c0-.552.448-1 1-1s1 .448 1 1v3h3c.552 0 1 .448 1 1z"}]])
