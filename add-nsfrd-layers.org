...
* TODO Write A psql trigger that inserts the nfdrs rows if the organizations.subscription_tier changes

if organization.subscription_tier is basic or higher then insert nfdrs rows for org into organization_layers.layer_path and layer_config
